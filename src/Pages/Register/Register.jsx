...
import img1 from "../../assets/6333057.jpg";
...
const Register = () => {
  ...
  return (
    <div className="flex justify-center animate__zoomIn items-center animate__animated animate__bounce">
      <Helmet>
        <title>MedCamp | Register</title>
      </Helmet>
      <div className="flex">
        <div>
          <img src={img1} alt="" />
        </div>
        <div className="w-full max-w-5xl p-8 shadow-lg border border-black space-y-3 rounded-xl dark:bg-gray-50 dark:text-gray-800">
